  ...
  //  private Nivel2 ventana;
   // private Modelo modelo;
    ...
    public ControladorNivel2(Modelo modelo){
        this.movY=true;
        this.movX=true;
        this.ventana = new Nivel2(modelo);
        this.modelo=modelo;
        this.ventana.getScene().setOnKeyPressed(new ToPressKeyEvent());
        this.ventana.getScene().setOnKeyReleased(new ToReleaseKeyEvent());
        this.ventana.getPause().setOnAction(new ControladorNivel2.PauseEvent());
        this.ventana.getReturnToMenuLose().setOnAction(new ControladorNivel2.ReturnToMenuEvent());
        this.ventana.getReturnToMenuWin().setOnAction(new ControladorNivel2.ReturnToMenuEvent());
}
